        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <Input {...register("password")} id="password" type="password" placeholder="New password" required />
              <FieldLabel htmlFor="confirm-password">Confirm Password</FieldLabel>
              {errors.password && (
                <FieldDescription className="text-red-500">{errors.password.message}</FieldDescription>
              )}
              <Input {...register("confirmPassword")} id="confirm-password" type="password" placeholder="Confirm new password" required />
